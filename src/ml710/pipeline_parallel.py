...
class PipelineParallel(nn.Module):
    ...
    def __init__(self, model, config):
        ...
        self.layer_distribution = self.layer_distribution(config.num_hidden_layers)
        ...
        self.layers = nn.ModuleDict({str(i): model.layers[i] for i in self.layer_distribution}) #Changed to Layers
    ...
    def reset_parameters(self):
        ...
        if pgm.process_group_manager.pp_is_first_stage:
            self.model.model.embed_tokens.reset_parameters()
